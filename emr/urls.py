...
urlpatterns = patterns('',
    ...
    url(r'^get_problems/(?P<user_id>\d+)/$', 'emr.views.get_problems'),
    url(r'^change_status/$', 'emr.views.change_status'),
    url(r'^patient/(?P<patient_id>\d+)/add_problem/$', 'emr.views.add_problem'),
    url(r'^list_terms/$', 'emr.views.list_terms'),
    (r'^media/(?P<path>.*)$', 'django.views.static.serve', {'document_root': settings.MEDIA_ROOT}),
        (r'^static/(?P<path>.*)$', 'django.views.static.serve', {'document_root': '/home/tim/core/static/'}),
