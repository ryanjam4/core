...
def get_problems(request, user_id):
    ...
    for problem in problems_query:
        ...
        d['concept_ids'][str(problem.concept_id)+'P'] = [i.__dict__ for i in pymedtermino.snomedct.SNOMEDCT[int(problem.concept_id)].parents if '(disorder)' in i.__dict__['term']]
